      ...
      <div className="grid grid-cols-2 max-w-screen-xl mx-auto">
        <div className="  mx-auto px-4 py-2   flex flex-col text-left justify-evenly">
          ...
          >
            ...
            <button
              type="button"
              className="py-2.5 mr-2 mb-2 mt-10 "
              aria-label="Contact Us Today"
              tabIndex={0}
            >
              <a href="#contact" className="text-white bg-blue-700/90 hover:bg-blue-800 focus:ring-4
         focus:ring-blue-300 font-medium rounded-sm text-sm px-10 py-2.5 
         shadow-md">Contact Us Today</a>
            </button>
          </div>
        </div>{" "}
        <img
          src={handyMan}
          className="h-full w-auto object-cover p-3"
          alt="Handy Man"
        />
      </div>
    </section>
